...
export function DialogDemoCotizacion() {
    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                <Button variant="outline">Crear Cotizacion</Button>
            </DialogTrigger>
                ...
                <DialogHeader>
                    ...
                    <DialogDescription className="flex flex-row justify-between">
                        <p>
                            ...
                            Agrega los datos para generar la Cotización
                        </p>
                        <DialogDemoCliente />
                    </DialogDescription>
                </DialogHeader>
                <div className="flex flex-col gap-4 py-4">
                    ...
                    <div className="flex flex-row items-center gap-4">
                        <div className="flex flex-col items-start gap-2">
                            ...
                            <Label htmlFor="numFactura">Num Cotización</Label>
                            <Input id="numFactura" value="Q00045" className="w-[200px]" readOnly />
...
export default DialogDemoCotizacion;