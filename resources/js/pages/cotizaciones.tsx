...
import { DialogDemoCotizacion } from '@/components/ui/modalcotizacion';
...
export default function Facturacion() {
    return (
        <AppLayout title="Cotización" description="Cotización de productos" breadcrumbs={breadcrumbs}>
            <Head title="Cotización" />

            <div className="mt-4 mb-4 flex flex-row gap-4">
                <DialogDemoCotizacion />
